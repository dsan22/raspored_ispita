<x-form-layout>
    <h2 class="text-xl font-semibold mb-4">Create New Classroom</h2>
    <form  method="POST" action={{route("classrooms.store")}}>
        ...
        <div>
            ...
            <x-text-input type="number" id="floor" class="block mt-1 w-full"  name="floor" :value="old('floor')" required autofocus/>
