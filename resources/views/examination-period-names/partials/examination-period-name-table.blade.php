    ...
    <div class="bg-white overflow-hidden shadow-sm">
        <div class="overflow-x-auto">
            <table class="table-auto min-w-full border-collapse">
                ...
                <tbody>
                    @foreach ($examinationPeriodNames as $examinationPeriodName)
                        <tr class="border-b text-gray-900">
                            <td class="p-4 sm:w-1/2 whitespace-nowrap">{{ $examinationPeriodName->name }}</td>
                            @ifAdmin
                            <td class="p-4 sm:w-1/2 whitespace-nowrap">
                                <div class="flex space-x-4 justify-center">
                                    {{ $action($examinationPeriodName) }}
                                </div>
                            </td>
                            @endif
                        </tr>
